...
| 4:35–5:20 | Production acceptance registry summary | Show 5 of 17 applicable gates passed and the explicit blockers | "A real production workflow must make its incomplete controls visible. Apply is deliberately unavailable." |
...
- Production acceptance: 5 of 17 applicable gates passed.
