...
- LISP Pub/Sub publisher/subscriber planning, native multicast with two
  Anycast-RP nodes, per-VN ASM/SSM overlay policies, ledger-backed multicast
  segment/core/BUM groups, deterministic shared-service route leaks, and
  hybrid ISE/SXP policy-plane intent.
